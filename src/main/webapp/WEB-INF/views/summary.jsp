...
<body>
	...
	<h1>Do you fancy some coffee?<img src="/images/coffee.png"></h1>
	<h2>Welcome to our rewards program, ${user.firstname} ${user.lastname} !</h2> 
</body>
</html>